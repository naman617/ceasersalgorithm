...
# Workbook() takes one argument which is the filename of the workbook that we want to create.
wb = input('enter the filename')
workbook = xlsxwriter.Workbook(f'{wb}.xlsx')

# The workbook object is then used to add new worksheet via the in-built add method.
